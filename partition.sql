...
CREATE TABLE sales_north PARTITION OF sales FOR VALUES IN (1);
CREATE TABLE sales_south PARTITION OF sales FOR VALUES IN (2);
CREATE TABLE sales_east PARTITION OF sales FOR VALUES IN (3);
CREATE TABLE sales_west PARTITION OF sales FOR VALUES IN (4);
...
CREATE TABLE sales_part3 PARTITION OF sales FOR VALUES WITH (MODULUS 4, REMAINDER 2);
CREATE TABLE sales_part4 PARTITION OF sales FOR VALUES WITH (MODULUS 4, REMAINDER 3);
